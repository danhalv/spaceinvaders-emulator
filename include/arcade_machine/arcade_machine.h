...
#define MACHINE_CYCLES_PER_FRAME \
  MACHINE_CLOCK_RATE /           \
      MACHINE_FPS  // 2x10^6 cpu per second. 60 frames per second
#define MACHINE_HALF_CYCLES_PER_FRAME \
  MACHINE_CYCLES_PER_FRAME / 2  // used for interrupts
